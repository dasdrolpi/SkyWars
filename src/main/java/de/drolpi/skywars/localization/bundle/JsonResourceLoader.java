package de.drolpi.skywars.localization.bundle;
...
public class JsonResourceLoader extends ResourceBundle.Control {
    ...
    private final static Path DIRECTORY = Paths.get("plugins", "SkyWars", "languages");

    private static final String FORMAT_NAME = "skywars.json";
    private final File resourceDirectory;
    private final Logger logger;

    public JsonResourceLoader() {
        this.resourceDirectory = DIRECTORY.toFile();
    ...
    private ResourceBundle createBundle(String resourceName, InputStream source) {
        ...
        JsonElement el = new JsonParser().parse(new InputStreamReader(source));
        if (!el.isJsonObject()) {
